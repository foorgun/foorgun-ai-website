      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/furkan-cetin-660004211/"
              target="_blank"
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/foorgun.ai/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 flex items-center justify-center border border-line text-white-muted hover:text-white hover:border-accent/40 transition-colors duration-200"
        ...
        <div className="flex flex-col gap-5">
          <p className="font-mono text-xs text-white uppercase tracking-widest">Navigation</p>
        ...
        {/* Col 3 — Company */}
        <div className="flex flex-col gap-5">
          <p className="font-mono text-xs text-white uppercase tracking-widest">Company</p>
          <div className="w-full h-px bg-line" />
          <nav className="flex flex-col gap-4">
            {[
              { label: "About", href: "#" },
        ...
        {/* Col 4 — Contact */}
        <div className="flex flex-col gap-5">
          <p className="font-mono text-xs text-white uppercase tracking-widest">Contact info</p>
          <div className="w-full h-px bg-line" />
